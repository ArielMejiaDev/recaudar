<template>
    <div class="w-full flex flex-col lg:flex-row">
        ...
        <div class="w-full lg:w-1/3 mb-6 lg:mb-0">
            <Title :info="trans.this_data_would_be_public_from_team_profile_site">{{ trans.create_a_plan }}</Title>
        </div>
        ...
        <form @submit.prevent="submit" class="w-full lg:w-2/3">
            <Panel>
                <template v-slot:body>
                    ...
                    <div class="w-full">
                        <ImageUploader v-model="form.banner" name="banner" label="Banner" :errors="$page.errors.banner" />
                    </div>
