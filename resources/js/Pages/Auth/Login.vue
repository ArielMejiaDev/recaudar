<template>
    ...
    <div class="flex max-w-sm mx-auto bg-white rounded-lg shadow-lg overflow-hidden lg:max-w-4xl">
        ...
        <form @submit.prevent="submit" class="w-full py-8 px-6 md:px-8 lg:w-1/2">
            ...
            <p class="text-md text-gray-600 text-center">Login</p>
            ...
            <div class="mt-4">
                <div class="flex items-start justify-between">
                    ...
                    <InertiaLink :href="route('password.request')" class="text-xs text-gray-500 hover:underline">Forget Password?</InertiaLink>
                </div>
            ...
            <div class="mt-8">
                <button class="w-full bg-gray-800 hover:bg-gray-900 text-white text-sm font-semibold rounded focus:outline-none focus:shadow-outline py-3">Login</button>
            </div>

            <div class="mt-4 flex items-center justify-between">
                <span class="border-b w-1/5 md:w-1/4"></span>

                <InertiaLink :href="route('register')" class="text-xs text-gray-500 uppercase hover:underline">or sign up</InertiaLink>
