            ...
            <div class="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4">
                ...
                @foreach ($team->availablePlans() as $plan)
                    ...
                    <div class="p-4 w-full lg:w-1/3 sm:mb-0 mb-6 z-10">
                        ...
                        <a @click.prevent="selectPlan({{ $plan }})" class="text-pink inline-flex items-center mt-3 hover:text-melon" href="#">
                            Donate <span class="ml-2" x-text="money_format({{ $plan->amount_in_local_currency }})"></span>
