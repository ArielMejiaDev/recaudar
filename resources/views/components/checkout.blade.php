...
{{--Floating button--}}
{{--<button @click="showModal = !showModal;planId = '';selectedAmount = ''" class="fixed bottom-0 right-0 m-2 lg:m-12 bg-melon rounded-lg py-2 px-4 text-white shadow-xl flex font-body hover:bg-pink z-20 focus:outline-none focus:shadow-outline">--}}
        ...
        <form id="{{ getFormId() }}" method="POST" @submit.prevent="submit()" id="checkout" class="w-full max-w-xl bg-white rounded shadow-xl relative py-4">
            ...
            <div class="py-2 px-4 md:px-8">
                ...
                <div class="bg-gray-200 rounded py-2">
                    ...
                    <div x-show="!selectedAmount" class="my-1 p-2">
