    ...
    <div class="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-screen-xl">
        ...
        <div class="relative">
            <h3 class="text-center text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl sm:leading-10">
                Somos el corazón de la caridad
            </h3>
        </div>

        <div id="mas" class="relative mt-12 lg:mt-24 lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
            <div class="relative">
                <h4 class="text-2xl leading-8 font-extrabold text-gray-900 tracking-tight sm:text-3xl sm:leading-9">
                    Se parta de la familia Recaudar
                </h4>
                <p class="mt-3 text-lg leading-7 text-gray-500">
                    Si eres una organización sin fines de lucro o o una causa que genera un impacto social,
                    seguramente necesitas obtener más ingresos para seguir impactando. Únete y se parte del equipo.
                </p>
                ...
                <ul class="mt-10">
                    <li>
                        <div class="flex">
                            ...
                            <div class="ml-4">
                                <h5 class="text-lg leading-6 font-medium text-gray-900">Fácil y seguro</h5>
                                <p class="mt-2 text-base leading-6 text-gray-500">
                                    Recaudar proporciona servicios que simplifican el proceso de donación para que siempre sea fácil y seguro.
                                </p>
                            </div>
                        </div>
                    </li>
            ...
            <div class="mt-10 mx-2 md-mx-4 relative lg:mt-0">
                ...
                <img class="relative mx-auto rounded-lg shadow-2xl" width="490" src="{{ asset('images/landing/features/feature-1.png') }}" alt="Se parte de la familia Recaudar" />
            </div>
        </div>
        ...
        <div class="relative mt-12 sm:mt-16 lg:mt-24">
            <div class="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-center">
                <div class="lg:col-start-2">
                    ...
                    <p class="mt-3 text-lg leading-7 text-gray-500">
                        Obtienes una serie de beneficios con tu plataforma:
                    </p>
                    ...
                    <ul class="mt-10">
                        <li>
                            <div class="flex">
                                ...
                                <div class="ml-4">
                                    <h5 class="text-lg leading-6 font-medium text-gray-900">Creación links directos para donación</h5>
                                    <p class="mt-2 text-base leading-6 text-gray-500">
                                        Enlaces que puedes compartir en redes sociales.
                                    </p>
                                </div>
                            </div>
                        </li>
                        <li class="mt-10">
                            <div class="flex">
                                ...
                                <div class="ml-4">
                                    <h5 class="text-lg leading-6 font-medium text-gray-900">Donación con monto variable</h5>
                                    <p class="mt-2 text-base leading-6 text-gray-500">
                                        Cualquier donador podrá donar un monto que desee.
                                    </p>
                                </div>
                            </div>
                        </li>
                ...
                <div class="mt-10 mx-2 md-mx-4 relative lg:mt-0 lg:col-start-1">
                    <svg class="absolute left-1/2 transform -translate-x-1/2 translate-y-16 lg:hidden" width="784"
                         height="404" fill="none" viewBox="0 0 784 404">
                        <defs>
                    ...
                    <img class="relative mx-auto rounded-lg shadow-2xl" width="490" src="{{ asset('images/landing/features/feature-2.png') }}" alt="Nuestro checkout" />
                </div>
            </div>
        </div>
    </div>
