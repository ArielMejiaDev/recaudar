<div id="quienes-somos" class="lg:px-8 mx-auto flex flex-col-reverse lg:flex-row items-center mt-6 lg:mt-0 lg:min-h-screen min-w-screen bg-white">
    ...
    <div class="relative w-full md:w-2/3 lg:w-1/2 h-full p-5 lg:pl-12">
        ...
        <a href="#pilares" class="underline font-medium flex items-center inline-block text-melon mt-8">
