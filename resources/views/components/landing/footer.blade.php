    ...
    <div class="container px-0 py-24 mx-auto lg:px-10">
        ...
        <div class="flex flex-wrap md:text-left text-center -mb-10 mx-2">
            ...
            <div class="lg:w-1/3 md:w-full w-full flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
                ...
                <a class="flex items-center lg:justify-start justify-center mb-6">
                    <div class="flex items-center flex-shrink-0 text-pink mr-6">
                        <svg class="fill-current h-6 w-6 lg:h-16 lg:w-16 mr-4" viewBox="0 0 1322 1062" fill="none" xmlns="http://www.w3.org/2000/svg">
