<div id="step-two" class="min-h-screen bg-primary overflow-hidden relative flex flex-col items-center justify-center relative pt-4 pb-20 lg:py-0 lg:py-0 font-body">

    <!-- Blobs -->
    <svg class="absolute fill-current text-darkprimary z-0" style="top: -100px; right: -400px" width="800" height="800" viewBox="0 0 600 600" xmlns="http://www.w3.org/2000/svg">
    ...
    <svg class="absolute fill-current text-darkprimary z-0" style="bottom: -400px; left: -350px" width="800" height="800" viewBox="0 0 600 600" xmlns="http://www.w3.org/2000/svg">
        <g transform="translate(300,300)">
