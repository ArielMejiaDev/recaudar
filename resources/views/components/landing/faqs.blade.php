<div id="faqs" class="min-h-screen bg-secondary flex items-start lg:items-center justify-center relative overflow-hidden py-8 font-body">

    <svg class="absolute fill-current text-darksecondary z-0" style="top: -125px; left: -25px" width="600" height="600" viewBox="0 0 600 600" xmlns="http://www.w3.org/2000/svg">
    ...
    <svg class="absolute fill-current text-darksecondary z-0" style="bottom: -200px; right: -140px" width="600" height="600" viewBox="0 0 600 600" xmlns="http://www.w3.org/2000/svg">
        <g transform="translate(300,300)">
