...
<body>
    ...
    <div x-data="{ open: true }">
        @if(Session::has('success'))
            <div x-cloak x-show.transition="open" @click.away="open = false" class="p-4 cursor-pointer rounded-lg bg-reddypink text-white fixed bottom-0 right-0 m-8 z-10 flex font-semibold font-display">
